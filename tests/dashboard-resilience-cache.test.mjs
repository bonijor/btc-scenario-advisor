...
import { adaptiveGridDisplay, readVerifiedSnapshot, saveVerifiedSnapshot, shadowValidationDisplay, snapshotIsSafe } from '../assets/dashboard-resilience.js';
...
function fixture(status='VERIFIED'){
  return {
    ...
    shadowValidation:{protocol:'btc-shadow-validation-progress/1.0',status:'COLLECTING',verifiedScore:44.2,targetScore:100,authorityCoveragePct:100,remainingVerifiedPoints:55.8,scoreMeaning:'SHADOW_VALIDATION_EVIDENCE_PROGRESS_NOT_TRADING_READINESS',canAuthorizeTrading:false,liveTradingEligible:false,countsTowardFormal90D:false,formalTrialMutation:false,sendToExchange:false}
  }
}
